...
def main():
    ...
    parser.add_argument(
        "-ms", "--mutational_signature", nargs=1, metavar="figures_folder"
    )
    parser.add_argument(
        "-tmb",
        "--total_mutation_burden",
        nargs=2,
        help="One item must be entered:\n \
                                                                          1. Sequencing Length\n",
    )
    parser.add_argument(
        "-oncokb",
        "--oncokb_annotator",
        nargs=4,
        help='Three items must be entered:\n \
    ...
    parser.add_argument(
        ...
        "--hrd_score",
        nargs=2,
        help="Two items must be entered:\n\
    ...
    parser.add_argument(
        ...
        help="The path for storing every generated file.\nThis path must end with a folder.\n",
    )
    ...
    if args.oncokb_annotator:
        ...
        df.data_analysis(
            folder,
            args.oncokb_annotator[0],
            args.oncokb_annotator[1],
            args.oncokb_annotator[3],
        )
